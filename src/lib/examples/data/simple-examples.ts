...
export const sort: ExampleData = {
	...
	description: '10,000 random numbers sorted on the edge. The receipt shows wall time.',
	problem: 'How fast is a sort in an isolate?',
	solution: 'Generate → sort → verify. One step.',
	result: '10k items sorted in ~2ms. The receipt proves it.',
	icon: 'arrow-up-down',
...
export const dedupe: ExampleData = {
	...
	result: '12 → 6. Removed 6 duplicates. The receipt has the exact list.',
	icon: 'filter',
...
export const regexTest: ExampleData = {
	...
	result: '8 inputs tested. 3 matched. The receipt has every result.',
	icon: 'search',
...
export const dateMath: ExampleData = {
	...
	result: 'Exact dates. No off-by-one. The receipt proves it.',
	icon: 'calendar',
...
export const hash: ExampleData = {
	...
	result: 'Deterministic SHA-256 hex. 64 characters. The receipt has it.',
	icon: 'hash',
...
export const validateJson: ExampleData = {
	...
	result: '4 valid, 3 invalid. The receipt shows the exact parse errors.',
	icon: 'file-json',
...
export const wordFrequency: ExampleData = {
	...
	result: '"the" appears 5 times. 16 words, 8 unique. The receipt has the full frequency map.',
	icon: 'text',
...
export const mapFilterReduce: ExampleData = {
	...
	description: '1,000 users. Filter active. Map emails. Reduce totals. The receipt shows timing.',
	problem: 'Every app processes arrays. Agents can offload the loop and prove the output.',
	solution: 'Generate 1k users → filter → map → reduce. Two steps. The receipt has the numbers.',
...
export const generateUuids: ExampleData = {
	...
	result: '100 UUIDs, all unique, <1ms. The receipt has the full list.',
	icon: 'key',
