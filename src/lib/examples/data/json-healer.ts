...
export const jsonHealer: ExampleData = {
	...
	startHere: true,
	featured: true,
	traceValue: 'In this successful example run, the saved result shows the failed parse, the repair step, and the final validated output in one shareable receipt.',
	steps: [
		{
