<script lang="ts">
  ...
  import TutorialStepNav from '$lib/tutorial/TutorialStepNav.svelte';
...
<DocsShell tocItems={[]}>
  <div class="max-w-3xl pb-16 text-[0.8125rem] text-(--text-2) leading-relaxed">
    <p class="mb-6">
      ...
      <AppLink to={paths.tutorial} class="text-(--text) no-underline hover:text-(--text) font-medium">Tutorial</AppLink>
    </p>
    <div class="mb-8">
      <TutorialStepNav />
    </div>
